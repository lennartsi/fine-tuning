...
model_name: qwen3-8b-instruct-fine-tune-V3
tags:
...
# Model Card for qwen3-8b-instruct-fine-tune-V3
...
generator = pipeline("text-generation", model="cookiebasher/qwen3-8b-instruct-fine-tune-V3", device="cuda")
